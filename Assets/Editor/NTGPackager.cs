...
public class NTGPackager
{
    ...
    {
        string dataPath = ResCtrl.DataPath; //打包到assetstream
        ...
        {
            resPath = "c:/" + AppConfig.ApplicationName.ToLower();
        }
        else
        {
        ...
        //BuildPipeline.BuildAssetBundles("c:/ssss/", BuildAssetBundleOptions.None, target);
        ...
        for (int i = 0; i < files.Count; i++)
        {
            ...
            string md5 = ResCtrl.GetFileMD5(file);
